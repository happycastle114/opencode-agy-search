...
current agent session. Require agy-search 0.2.8 or newer. On the normal
...
CLI 0.2.8 internally performs a bounded advisory catalog lookup and prefers
...
original deadline, escalating only its two internal recovery attempts; do not
wrap it in another identical retry.
